...
Maintenance.DiscordLink = 'https://discord.gg/kcgKxtHgCf'
...
print("^4 fivem-maintenance - By CriticalR#0563 - https://github.com/CriticalRR/fivem-maintenance - https://discord.gg/kcgKxtHgCf^0")
